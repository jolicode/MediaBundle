...
class MediaAdminControllerTest extends WebTestCase
{
    ...
    public function testSearchFormIsOnlyDisplayedInTheChooseMediaModal(): void
    {
    ...
    public function testSearch(): void
    {
        ...
        $crawler = $this->client->request(Request::METHOD_GET, '/admin?routeName=joli_media_easy_admin_choose&search=deep');
        $this->assertResponseIsSuccessful();
        ...
        $this->client->request(Request::METHOD_GET, '/admin?routeName=joli_media_easy_admin_choose&routeParams%5Bkey%5D=/sub&search=circle');
        $this->assertResponseIsSuccessful();
        $this->assertSelectorCount(1, 'ul.gallery-grid--files .gallery-grid-item');

        $this->client->request(Request::METHOD_GET, '/admin?routeName=joli_media_easy_admin_choose&routeParams%5Bkey%5D=/not_used&search=circle');
        $this->assertResponseIsSuccessful();
        $this->assertSelectorCount(0, 'ul.gallery-grid--files .gallery-grid-item');

        // a search without any match displays empty results
        $this->client->request(Request::METHOD_GET, '/admin?routeName=joli_media_easy_admin_choose&search=doesnotexist');
        $this->assertResponseIsSuccessful();
    ...
    public function testSearchResultsAreSorted(): void
    {
        ...
        $crawler = $this->client->request(Request::METHOD_GET, '/admin?routeName=joli_media_easy_admin_choose&search=pdf');
        $this->assertResponseIsSuccessful();
    ...
    {
        $this->client->request(Request::METHOD_GET, '/admin?routeName=joli_media_easy_admin_choose&search=pdf&page=1');
        $this->assertResponseIsSuccessful();

        $this->client->request(Request::METHOD_GET, '/admin?routeName=joli_media_easy_admin_choose&search=pdf&page=2');
