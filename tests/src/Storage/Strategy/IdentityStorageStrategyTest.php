...
class IdentityStorageStrategyTest extends TestCase
{
    private IdentityStorageStrategy $strategy;

    protected function setUp(): void
    {
        $this->strategy = new IdentityStorageStrategy();
    }
    ...
    public function testGetRoutePattern(): void
    {
        ...
        self::assertEquals('{slug}', $this->strategy->getRoutePattern(true));
    }
}
