...
use JoliCode\MediaBundle\Bridge\SonataAdmin\Twig\JoliMediaSonataAdminExtension;
...
return static function (ContainerConfigurator $container): void {
    $container->services()
        ...
        // twig
        ->set('joli_media_sonata_admin.twig_extension', JoliMediaSonataAdminExtension::class)
        ->tag('twig.extension')
