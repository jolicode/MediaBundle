...
To enable the integration, you need to register the ``JoliMediaSyliusAdminBundle`` in your Symfony application. Add the following line to your ``bundles.php`` file::
